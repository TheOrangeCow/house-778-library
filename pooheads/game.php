...
window.onload = refreshGame;
    ...
    <body>
        <h1>Pooheads - Room <?php echo $roomCode; ?></h1><button onclick="copyLink()">Copy Link</button>
        <p>You are: <b><?php echo $username; ?></b></p>
        ...
        <div class="game">
            <div id="main">
                ...
                <div id="yourcards">
                    <div id="yourhand"></div>
                    <div id="yourface"></div>
                    <div id="yourbottom"></div>
                </div>
            </div>
        </div>
        <div id="others"></div>
        <div id="wininglist"></div>
    </body>
